    ...
    protected void onHandleIntent(Intent intent) {
        ...
        switch (notifType) {
            ...
            case "notifUpdate":
                ...
                break;
            case "notifWeekly":
                smsSender = getString(R.string.NS_didyouknow_title);
                Random r = new Random();
                int i1 = r.nextInt(notifWeeklyArr.length);
                smsContent = notifWeeklyArr[i1];
                nID = 3;
                break;
            case "notifPermission":
                smsSender = getString(R.string.NS_notif_cantwork);
                String txt = getString(R.string.NS_notif_permission_title);
                smsContent = ( txt +" "+ dataArray[0]);
                if (dataArray[1].equals("true")){
                myAppSettings = new Intent(Settings.ACTION_MANAGE_OVERLAY_PERMISSION,
